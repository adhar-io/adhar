...
**Status**: Accepted (DataPlane API + controller, `adhar.io/plane` labels, control-plane Kyverno policy, and `adhar get dataplanes` / `adhar upgrade split-planes` CLI scaffolded; live multi-cluster validation is Roadmap Phase 2) · **Date**: 2026-08
