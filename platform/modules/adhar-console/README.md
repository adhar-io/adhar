...
A [timoni.sh](http://timoni.sh) module for deploying adhar-console to Kubernetes clusters.
...
```shell
timoni -n default apply adhar-console oci://<container-registry-url>
```
...
```shell
timoni -n default delete adhar-console
```
