...
A [timoni.sh](http://timoni.sh) module for deploying adhar-backstage to Kubernetes clusters.
...
```shell
timoni -n default apply adhar-backstage oci://<container-registry-url>
```
...
```shell
timoni -n default delete adhar-backstage
```
