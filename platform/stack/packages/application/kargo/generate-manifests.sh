...
helm template --namespace adhar-system kargo oci://ghcr.io/akuity/kargo-charts/kargo -f values.yaml --version ${CHART_VERSION} --set crds.enabled=true >>${INSTALL_YAML}