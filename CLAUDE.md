...
- **Standardization as enablement, not constraint** — battle-tested patterns with 96 packages pre-configured
...
│   │   ├── adhar-appset-local.yaml  # ArgoCD ApplicationSet (101 elements / 96 packages, enabled-gated; 17 enabled locally; adhar-appset-production.yaml: 75 enabled)
...
## Integrated Services (96 packages)
...
### GitOps Phase (96 packages / 101 ApplicationSet elements; 75 enabled in production, 17 in the local development core)
