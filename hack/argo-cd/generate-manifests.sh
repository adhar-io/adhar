...
MANIFEST_DIR="platform/controllers/adharplatform/resources/argo-cd" # Changed 'argocd' to 'argo-cd'
...
helm template argo-cd argo/argo-cd --version "$ARGOCD_VERSION" -f "$HACK_DIR/values.yaml" --include-crds > "$INSTALL_YAML"
